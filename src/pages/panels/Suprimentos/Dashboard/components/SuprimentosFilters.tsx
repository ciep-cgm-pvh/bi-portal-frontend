...
// src/pages/panels/Suprimentos/Dashboard/components/SuprimentosFilters.tsx

import { useEffect, useState } from 'react';
import FiltersSection from '../../../../../components/FiltersSection/FiltersSection';
import { useFiltersConfig } from '../hooks/useFilterConfig';

interface SuprimentosFiltersProps {
  initialValues: any;
...
export const SuprimentosFilters = ({
  initialValues,
  onApply,
  onClear,
  isLoading,
}: SuprimentosFiltersProps) => {
