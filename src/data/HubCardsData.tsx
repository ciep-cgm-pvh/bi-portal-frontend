 ...
 */
const HubCardsDataDeveloper: HubCardInterface[] = [
  {
    title: "Diárias (demo)",
  ...
  },
  {
    ...
    route:
      "https://lookerstudio.google.com/reporting/613ae68b-beee-4091-9f6b-7aa1da14de8b/page/TAEHF",
    icon: <TicketsPlane className="text-blue-400 w-6 h-6" />,
    type: "Gestão",
  },
  {
    ...
    route:
      "https://lookerstudio.google.com/u/0/reporting/973f6e54-754d-4e03-9bd9-aedeea124ca2/page/7jzHF",
  ...
  },
  {
    ...
    route:
      "https://lookerstudio.google.com/u/0/reporting/a41d513b-d75c-40bd-93e3-8f53825a1966/page/inJJF/edit",
  ...
  // },
  {
    ...
    description:
      "Painel de acompanhamento de contratos e convênios. Dados por SEMESC.",
    route:
      "https://lookerstudio.google.com/u/0/reporting/411daa19-5fee-4c94-9aff-c9d7bfa6d82c/page/LfYfE",
  ...
  },
  {
    ...
    description:
      "Painel com dados de manifestações da ouvidoria desenvolvido pela SMTI.",
  ...
  },
  {
    ...
    description:
      "O Tribunal de Contas da União (TCU) lançou o Painel que monitora o progresso das obras paralisadas no setor educacional que estão sendo retomadas em todo o país.",
    route:
      "https://app.powerbi.com/view?r=eyJrIjoiM2NmMTdlYzctOTY3My00ZWZhLWI3ODQtN2YyZDEzNDY1MTk1IiwidCI6ImJmMTU4MTg4LTlhMTEtNDRjMi1iN2ZjLTIxZTg1NjEzYmEyNyJ9",
...
export default function getHubCardsData() {
  return import.meta.env.VITE_ENV === "PRODUCTION"
    ? HubCardsDataProduction
    : HubCardsDataDeveloper;
}
